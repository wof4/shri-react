        ...
        {({
          ...
          <Form>
            <div className={s.build__input_container}>
              {values.commitHash !== '' ? (
                <img
                  onClick={() => { setFieldValue('commitHash', ''); }}
              ...
              <div className={s.build__buttons}>
                <div
                  ...
                  className={!isValid || !dirty ? s.build__button : s.build__button_run}
                  role="presentation"
                >
                  Run build
                </div>
                <div onClick={() => { closeBuildForm(); }} className={s.build__button_cansel} role="presentation">Cansel</div>
              </div>
            </div>
          </Form>
        )}
